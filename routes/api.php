...
Route::group(['prefix' => 'v2', 'middleware' => ['app_language']], function () {
	...
	Route::post('contact-us', [ContactController::class, 'storeContactUs']);
    ...
    Route::controller(CartController::class)->group(function () {
        ...
        Route::post('carts/change-quantity', 'changeQuantity')->middleware('auth:sanctum');
        Route::get('carts', 'getList')->middleware('auth:sanctum');
        Route::post('guest-customer-info-check', 'guestCustomerInfoCheck');
        Route::post('updateCartStatus', 'updateCartStatus');

        Route::post('/cart/toggle', 'toggleCart')->middleware('auth:sanctum');
        Route::get('/cart/products', 'get_cart_products')->middleware('auth:sanctum');
        Route::get('/carts/productsIds', 'get_all_product_ids')->middleware('auth:sanctum');

    });

    Route::controller(CheckoutController::class)->group(function () {
        Route::post('coupon-apply', 'apply_coupon_code')->middleware('auth:sanctum');
        Route::post('coupon-remove', 'remove_coupon_code')->middleware('auth:sanctum');
    });
    ...
    Route::controller(ShippingController::class)->group(function () {
        ...
        Route::post('shipping_cost', 'shipping_cost')->middleware('auth:sanctum');
    });
    Route::post('carriers', [CarrierController::class, 'index']);


    Route::controller(AddressController::class)->group(function () {
        Route::post('update-address-in-cart', 'updateAddressInCart')->middleware('auth:sanctum');
        Route::post('update-shipping-type-in-cart', 'updateShippingTypeInCart')->middleware('auth:sanctum');
    });
    ...
    Route::group(['middleware' => ['app_user_unbanned']], function () {
        ...
        // Payment routes
        Route::post('payments/pay/combined-wallet', [PaymentTypesController::class, 'combinedWalletPayment'])->middleware('auth:sanctum');
        ...
        Route::controller(WishlistController::class)->middleware('auth:sanctum')->group(function () {
            ...
            Route::post('/wishlist/toggle/{id}', 'toggle');
            Route::get('/wishlist/productsIds', 'get_all_product_ids');
        });
        ...
        Route::get('clubpoint/convert-into-wallet', 'App\Http\Controllers\Api\V2\ClubpointController@convert_into_wallet')->middleware('auth:sanctum');
        ...
        Route::get('profile/referral_code/', 'App\Http\Controllers\Api\V2\ProfileController@get_refferal_code')->middleware('auth:sanctum');
        Route::get('profile/user', 'App\Http\Controllers\Api\V2\ProfileController@getUserProfile')->middleware('auth:sanctum');
        Route::post('update/confirmation', 'App\Http\Controllers\Api\V2\ProfileController@confirmCode')->middleware('auth:sanctum');
        Route::post('profile/changepass', 'App\Http\Controllers\Api\V2\ProfileController@changePassword')->middleware('auth:sanctum');
    ...
    Route::get('products/category/{id}', 'App\Http\Controllers\Api\V2\ProductController@categoryProducts')->name('api.products.category');
	...
	Route::get('products/categories-price', 'App\Http\Controllers\Api\V2\ProductController@getCategoriesWithPriceRange');
    ...
    Route::get('productdetails/{id}', [ProductController::class, 'findById']);
    //Route::get('products/related-product/{id}', [ProductController::class, 'findBrelatedProductsyId']);
    Route::get('products/relates/{id}', [ProductController::class, 'lates_products']);
    ...
    Route::get('cities-by-countries/{id}', 'App\Http\Controllers\Api\V2\AddressController@getCitiesBycountrie');
