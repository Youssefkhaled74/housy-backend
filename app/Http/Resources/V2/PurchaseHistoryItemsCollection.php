        ...
        return [
            'data' => $this->collection->map(function ($data) {
                ...
                return [
                    ...
                    'product_name' => translate($data->product->name),
                    ...
                    'delivery_status_string' => $data->delivery_status == 'pending' ? translate("Order Placed") : ucwords(str_replace('_', ' ', translate($data->delivery_status))),
